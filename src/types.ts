...
export interface AppLockSettings {
  isEnabled: boolean;
  pinHash: string; // 4 or 6 digit PIN (encrypted/hashed)
  isFingerprintEnabled: boolean;
  isFaceUnlockEnabled: boolean;
  autoLockTimeout: number; // in minutes: 0 = Immediately on blur, 1, 5, 15, 30, -1 = Never
...
export interface CalendarEvent {
  ...
  time?: string; // HH:mm
  category: 'work' | 'study' | 'personal' | 'ai_task';
  isCompleted?: boolean;
